...
namespace SACNPackets
{
	    public class SACNPacket
    {
        ...
        public SACNPacket(Int16 universeID, String sourceName, Guid uuid, byte sequenceID, byte[] data, Int16 syncAddress = 0, bool syncPacket = false)
        {
            RootLayer = new RootLayer(uuid, sourceName, universeID, sequenceID, data, syncAddress, syncPacket);
        }
    ...
    public class RootLayer
    {
        ...
        public RootLayer(Guid uuid, string sourceName, Int16 universeID, byte sequenceID, byte[] data, Int16 syncAddress = 0, bool syncPacket = false)
        {
            UUID = uuid;
            FramingLayer = new FramingLayer(sourceName, universeID, sequenceID, data, syncAddress, syncPacket);
            //Console.WriteLine($"Uni {universeID} SyncAddress {syncAddress} SyncPacket {syncPacket}");
        }
    ...
    public class FramingLayer
    {
        ...
        static Int32 VECTOR_E131_EXTENDED_SYNCHRONIZATION = 0x00000001;
        static byte PRIORITY = 100;
            //static Int16 RESERVED = 0;  //SyncAddress
        ...
        public Int16 Length
        {
            ...
            {
                if (DMPLayer != null)
                    return (Int16)(77 + DMPLayer.Length);
                else
                    return (Int16)77;
            }
        }
        ...
        public FramingLayer(string sourceName, Int16 universeID, byte sequenceID, byte[] data, Int16 syncAddress = 0, bool syncPacket = false)
        {
            //Console.WriteLine($"Uni {universeID} SyncAddress {syncAddress} SyncPacket {syncPacket}");
